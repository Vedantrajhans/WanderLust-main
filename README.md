...
👨‍💻 About Me
I'm Vedant Rajhans, a Full-Stack Web Developer and B.Tech CSE student passionate about building scalable, intelligent web applications that solve real-world problems.
🔧 Tech I Work With

Frontend: React, Next.js, Redux, Tailwind CSS
Backend: Node.js, Express.js, MongoDB, PostgreSQL
DevOps: Docker, AWS, Vercel, MongoDB Atlas
APIs: RESTful APIs, Zoom, Stripe, SendGrid
Other: Real-time systems, Authentication, File uploads

I specialize in full-stack applications with complex workflows, third-party integrations, and user-centric design.
